...
# Decision Tree predictions (breast cancer dataset)
y_pred_dt = dt_constrained.predict(X_test)  # X_test from breast cancer, shape (num_samples, 30)
cm_dt = confusion_matrix(y_test, y_pred_dt)
print("Decision Tree Confusion Matrix:\n", cm_dt)

# Neural Network predictions (breast cancer dataset)
y_pred_nn_prob = neural_network_model.predict(X_test_scaled)  # scaled breast cancer features
y_pred_nn = (y_pred_nn_prob > 0.5).astype(int)
cm_nn = confusion_matrix(y_test, y_pred_nn)
print("Neural Network Confusion Matrix:\n", cm_nn)


# Comments on model preference
# I would prefer the Decision Tree model for this task because it gives good accuracy and is easy to interpret.
